...
const projects = [
  ...
  { mainImage: 'Nextjs', title: 'Portafolio', description: 'Plataforma de portafolio construida con Next.js y TypeScript.', technologies: 'Next.js, TypeScript, Tailwind, React', url: 'https://portafolio-new-jet.vercel.app/', githubUrl: 'https://github.com/alexbk09/portafolio-new', accent: 'cyan' },
