...
const projects = [
  ...
  { mainImage: 'images/ecommerce.png', title: 'Portafolio Nextjs', description: 'Plataforma de portafolio construida con Next.js y TypeScript.', technologies: 'Next.js, TypeScript, Tailwind, React', url: 'https://portafolio-new-jet.vercel.app/', githubUrl: 'https://github.com/alexbk09/portafolio-new', accent: 'cyan' },
  { mainImage: 'images/ecommerce.png', title: 'Portafolio laravel + reactjs', description: 'Plataforma de portafolio construida con Laravel y React.js.', technologies: 'TypeScript, Tailwind, React, Laravel, MySQL, Microservicio IA (FastAPI)', url: '', githubUrl: 'https://github.com/alexbk09/portafolio_repository', accent: 'violet' },
  { mainImage: 'images/ecommerce.png', title: 'Dantojos + react', description: 'Plataforma de pedidos de tortas en base a opciones se arma el pedido a solicitar con precios y se envia a travez de WhatsApp, responsive, tailswind, creado en React.js.', technologies: 'TypeScript, Tailwind, React', url: 'https://dantojos.vercel.app/', githubUrl: 'https://github.com/alexbk09/dantojos', accent: 'lime' },
  { mainImage: 'images/ecommerce.png', title: 'Ilumax React + Supabase', description: 'Plataforma tienda construida con react.js, TypeScript y supabase mostrando productos precios en dos monedas consumiendo un api y carrito de compra con una parte administrativa para ela dministrador para manejar productos solicitudes y dahsboard de informacion.', technologies: 'sapabase, TypeScript, Tailwind, React', url: 'https://ilumax.vercel.app/', githubUrl: 'https://github.com/alexbk09/ilumax', accent: 'lime' },
